...
&\implies\sum\limits_{i=1}^n|c_i|^2=0\\
\end{align}

We take care to note that $\sum\limits_{i=1}^n|c_i|^2$ is the sum of non-negative terms. Since this sum equals 0, that means that every term in the sum is zero. Observe that
...
Thus, the orthonormal set is linearly independent, which is what we wanted to show.
:::