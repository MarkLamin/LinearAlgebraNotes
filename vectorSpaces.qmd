...
> Let $V$ be an inner product space. Then, for $v\in V$, the *norm* of $V$, notated as $\|v\|$ is defined to be $\|v\|=\sqrt{\langle v,v\rangle}$^[In some texts, the term here is the *induced norm* by the inner product, and the notion of a norm is generalized to be a function that has a particular set of properties, including those proved in the following theorem.]
